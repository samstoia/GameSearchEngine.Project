...
namespace GameSearchEngine.Models
{
    public class Game
    {
        ...
        public void Save()
        {
            ...
            cmd.CommandText = @"INSERT INTO games (title, description, genre, platforms, year_released, rating, image_Large, thumbnail_Image) VALUES (@title, @description, @genre, @platforms, @year_released, @rating, @image_Large, @thumbnail_Image);";
            MySqlParameter title = new MySqlParameter();
            MySqlParameter description = new MySqlParameter();
            MySqlParameter genre = new MySqlParameter();
            MySqlParameter platforms = new MySqlParameter();
            MySqlParameter year_released = new MySqlParameter();
            MySqlParameter rating = new MySqlParameter();
            MySqlParameter imageLarge = new MySqlParameter();
            MySqlParameter thumbnailImage = new MySqlParameter();
            ...
            year_released.ParameterName = "@year_released";
            year_released.Value = this.GetYear();
            rating.ParameterName = "@rating";
            rating.Value = this.GetRating();
            imageLarge.ParameterName = "@image_Large";
            imageLarge.Value = this.GetImage();
            thumbnailImage.ParameterName = "@thumbnail_Image";
            thumbnailImage.Value = this.GetThumb();
            cmd.Parameters.Add(title);
            cmd.Parameters.Add(description);
            cmd.Parameters.Add(genre);
            cmd.Parameters.Add(platforms);
            cmd.Parameters.Add(year_released);
            cmd.Parameters.Add(rating);
            cmd.Parameters.Add(imageLarge);
            cmd.Parameters.Add(thumbnailImage);
            cmd.ExecuteNonQuery();
            conn.Close();
            if (conn != null)
            {
